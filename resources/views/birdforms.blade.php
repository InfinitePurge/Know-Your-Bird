    ...
    <div class="main-content">
        <div class="sidebar">
            <div class="sidebar-container" >
                <ul>
                    <li><a href="#Bird Forms">Bird Forms</a></li>
                    <li><a href="#Feathers">Feathers</a></li>
                    <li><a href="#Molting">Molting</a></li>
                    <li><a href="#Colour">Colour</a></li>
                    <li><a href="#Other external features">Other external features</a></li>
                    <li><a href="#Skeleton">Skeleton</a></li>
                    <li><a href="#Muscles and organs">Muscles and organs</a></li>
                </ul>
            </div>
        </div>
        <main class="content">
            <div class="content_inner">
                <section id="Bird Forms">
                   <h1>Bird Forms</h1>
                ...
                <section id="Other external features">
                    <h1>Other external features</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                        laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in
                        voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
                ...
                <section id="Muscles and organs">
                    <h2>Muscles and organs</h1>
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut
                        labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco
                        laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in
                        voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat
