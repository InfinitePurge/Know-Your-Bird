...
<body>
    ...
    <div class="button-container">
        @foreach ($quizzes as $quiz)
            <button class="buttons buttonhome"
                onclick="window.location.href='/quizz/{{ $quiz->title }}'">{{ $quiz->title }}</button>
        @endforeach
    </div>
        ...
        <div class="box">
            ...
            <div class="modal-container" id="m3-o" style="--m-background: var(--global-background); display: none;">
                <div class="modal" style="--m-shadow: 0 0 10rem 0">
                    ...
                    <p class="modal__text">Welcome! Log in to save your quiz progress, register for an account to unlock
                        additional features, or continue as a guest to explore and have fun without an account.</p>
    ...
    <script>
        ...
        function setModalShownCookie() {
            ...
            document.cookie =
                `lastModalShown=${currentDate.toUTCString()}; expires=${expirationDate.toUTCString()}; path=/`;
        }
