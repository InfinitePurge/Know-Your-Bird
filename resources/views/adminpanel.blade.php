				...
				<table class="table table-striped table-hover">
					...
					<tbody>
						<tr>
							...
							<td>Meras</td>
							<td>
<a href="#editOptionsModal" class="edit" data-toggle="modal">
  <i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i>
</a>								<a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
							</td>
						</tr>
	...
	<!-- Edit Modal HTML -->
	<div id="editOptionsModal" class="modal fade">
